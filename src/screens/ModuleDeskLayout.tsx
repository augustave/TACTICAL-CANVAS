...
export function ModuleDeskLayout({ children, featureCount, featureSummary }: Props) {
  return (
    <div className="desk-texture flex-1 min-h-0 w-full p-4 md:p-8 grid grid-cols-1 lg:grid-cols-2 grid-rows-[auto_1fr] gap-0 relative overflow-hidden">
      <ClassificationStrip />
      ...
      <div className="relative z-10 flex flex-col gap-4 min-h-0 overflow-y-auto">
        {children}
      </div>
